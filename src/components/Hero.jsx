    ...
    return (
        <section style={{width: "95%"}} className="relative w-5/6 sm:w-full h-screen mx-auto">
            ...
            >
                ...
                <div>
                    ...
                    <p className={`${styles.heroSubText} mt-2 text-white-100`}>
                        <p style={{fontSize: '20px'}}>Software Developer at <span
                            style={{color: '#1589F6'}}>Vendus</span></p>
                    </p>
                </div>
            </div>
            <ComputersCanvas/>
            ...
            <div className='absolute xs:bottom-10 bottom-32 w-full flex justify-center items-center'>
                <a href='#about'>
                    <div
                        className='w-[40px] h-[70px] rounded-3xl border-4 border-white flex justify-center items-start p-2'>
                        <motion.div
                            animate={{
                                y: [0, 24, 0],
                            }}
